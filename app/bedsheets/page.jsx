...
const Home = () => {
  const images = [
    "/img5.jpg",
    "/Velvet new _page-0015.jpg",
    "/Velvet new _page-0012.jpg",
    "/Velvet new _page-0012.jpg",
    "/Velvet new _page-0014.jpg",
    "/Velvet new _page-0008.jpg",
    "/img31.jpg",
  ];
  ...
  useEffect(() => {
    const filtered = products.filter((product) => {
      ...
      return isCategoryMatch && isPriceInRange && isFabricMatch && isBedSizeMatch;
    });
